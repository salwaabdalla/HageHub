...
export function QuestionCard({ question, onOpen }) {
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: '18px 22px', display: 'flex', flexDirection: 'column', gap: 10, minWidth: 0 }}>
        ...
        {question.images?.[0] && !question.images[0].startsWith('data:') && (
          <img
